...
class QuestionsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        // question6
        questions.append(Question(questionText: "6 - Which of these seeds are richest in healthy omega-3 fats?", imageURL: "omega3_seeds", answers: ["Pumpkin", "Flax", "Sunflower"], correctAnswers: [1], correctAnswerDetail: "Flax seeds, which need to be ground, are the richest plant sources of omega-3 fats. Chia seeds are a close second."))
